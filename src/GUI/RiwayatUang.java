 ...
 * @author User
 */
public class RiwayatUang extends javax.swing.JFrame {
    ...
    private void tabel(){
        ...
        tb.addColumn("Harga");
        this.tUang.setModel(tb);
        try{
            rs = stat.executeQuery("select * from pengirimanuang");
            while ( rs.next() ){
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Riwayat Pengiriman Uang");

        tUang.setBackground(new java.awt.Color(202, 194, 166));
        tUang.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        tUang.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tUang);
        ...
        MenuRiwayat.setText("File");

        menuAwal.setText("Menu Awal");
        MenuRiwayat.add(menuAwal);

        menuRiwayat.setText("Menu Riwayat");
        MenuRiwayat.add(menuRiwayat);
    ...
    private javax.swing.JTable tUang;
